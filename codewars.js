...
function sqInRect(lng, wdth){
  let area = lng * wdth
  let width =  Math.min(lng, wdth)
  let length = Math.max(lng, wdth)
  let thingToReturn = []

  console.log('inital area is', area)
  // console.log(Math.max(lng, wdth))
  // console.log('First number returned', width)

  thingToReturn.push(width)
  console.log('first square is', Math.pow(width, 2))
  area -= Math.pow(width, 2)
   console.log('area left after first square removed', area)
  // console.log('second number returned',length - width )
  
  thingToReturn.push(length - width)
  console.log('second square is', Math.pow((length - width), 2))
  area -= Math.pow((length - width), 2)
  console.log('last area before loop is', area)


  while(area >= 1){
  console.log(Math.floor(Math.sqrt(area)))
  thingToReturn.push(Math.floor(Math.sqrt(area)))
  area -= Math.pow(Math.floor(Math.sqrt(area)), 2)
  console.log('area after loop square', area)
